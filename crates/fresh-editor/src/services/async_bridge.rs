...
use lsp_types::{
    CodeActionOrCommand, CompletionItem, Diagnostic, InlayHint, InlineCompletionItem, Location,
...
pub enum AsyncMessage {
    ...
    LspInitialized {
        ...
        /// Whether the server supports inline completions (ghost text)
        inline_completion_supported: bool,
    ...
    /// LSP inline completion response (ghost text)
    LspInlineCompletion {
        request_id: u64,
    ...
    fn test_async_bridge_send_receive() {
        ...
        sender
            .send(AsyncMessage::LspInitialized {
                ...
                inline_completion_supported: false,
